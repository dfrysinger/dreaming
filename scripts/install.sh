...
REQUESTED_BRIDGE_ENV_NAMES=(
  ...
  DREAMING_COPILOT_ESTATE_SSH_SCRIPT
  DREAMING_COPILOT_ESTATE_COLLECTOR_SCRIPT
...
configure_native_adapters() {
  ...
  export_runtime_env
  if [[ "${DREAMING_PRESERVE_ESTATE_ADAPTERS:-0}" == "1" ||
        "${DREAMING_PRESERVE_OPERATIONAL_ADAPTERS:-0}" == "1" ]]; then
