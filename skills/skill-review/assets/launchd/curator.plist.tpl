...
<dict>
  ...
  <array>
    ...
    <string>__DREAMING_REPO_ROOT__/skills/skill-curator/references/tick-prompt.txt</string>
    <string>--name</string>
    <string>skills-curator</string>
  </array>
  ...
  <string>__HOME__/.copilot/skill-state/daemon-logs/launchd-curator.out</string>
  <key>StandardErrorPath</key>
  <string>__HOME__/.copilot/skill-state/daemon-logs/launchd-curator.err</string>
