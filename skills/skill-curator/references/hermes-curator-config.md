...
```bash
"$DREAMING_REPO_ROOT/skills/skill-curator/scripts/curator-state.sh" set paused true
```

To resume:

```bash
"$DREAMING_REPO_ROOT/skills/skill-curator/scripts/curator-state.sh" set paused false
```
