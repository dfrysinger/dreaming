...
roots=(
  "${DREAMING_REPO_ROOT:-$(cd "$(dirname "${BASH_SOURCE[0]}")/../../.." && pwd -P)}/skills"
  "${DREAMING_SHARED_SKILLS_ROOT:-$HOME/.copilot/dreaming/deps/current}/skills"
  "${SKILLS_REPO_ROOT:-$HOME/code/skills}/skills"
  "${SKILLS_LOCAL_ROOT:-$HOME/.copilot/skills}"
)
