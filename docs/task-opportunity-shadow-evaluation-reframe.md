...
R1-R3 and N1-N2. Round two accepted the candidate-blind packet isolation of
revision 2 as resolved and the O4-O6 directions as consistent. Reframe status
remains OPEN pending round-three review.
